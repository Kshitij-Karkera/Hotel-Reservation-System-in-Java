...
public class viewCustDetails extends JFrame implements ActionListener {
  JLabel imageLabel1;
  ImageIcon image1;
  Container container = getContentPane();
  JButton viewTableButton = new JButton("VIEW");
  JPanel panel = new JPanel();
  String tbcol[] = {"Username", "Firstname", "Lastname", "EmailID", "Phoneno", "Feedback", "Check-in", "Check-out", "RoomID"};
  ...
  public void actionPerformed(ActionEvent ae) { 
    ...
    if(str.equals("VIEW")) {
      try
      {
        ...
        ps = con.prepareStatement("select Username, Firstname, Lastname, EmailID, Phoneno, Feedback, Check_in, Check_out, Room_ID from User");
        rs = ps.executeQuery();
